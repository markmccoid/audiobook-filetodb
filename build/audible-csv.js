...
function processAudibleObjArr() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let book of bookData) {
            ...
            book.googleAPIData = (yield (0, fetchData_1.getBookData)(book.Author, book.Title)) || {};
...
function processData(data) {
    ...
    for (let el of data) {
        const bookEl = el.reduce((final, item, index) => {
            final = Object.assign(Object.assign({}, final), { [header[index]]: item.replace("|", ",") });
            return final;
        }, {});
...
function mergeAudibleData() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let book of bookData) {
            const audibleData = yield (0, audibleFetch_1.getAudibleData)(book.author, book.title);
