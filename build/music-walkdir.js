...
async function musicWalkerWithSongs(dir, currDepth = 0, // If you want to start at different level you can send -1
artistsArray = [], 
...
//~ ------------------------------------------------
//~ ------------------------------------------------
async function musicWalker(dir, currDepth = 0, artistsArray = [], 
// artistAlbums: { artist: string; albums: string[] }[] = [],
